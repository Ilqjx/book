...
create table t_order (
    ...
    constraint order_user_id_fk foreign key (user_id) references t_user (id)
);
...
create table t_order_item (
    ...
    constraint order_item_order_id_fk foreign key (order_id) references t_order (order_id)
);

# 向 t_user 表中插入数据
insert into t_user(`id`, `username`, `password`, `email`)
values (null, 'admin', 'admin', 'admin@163.com');
